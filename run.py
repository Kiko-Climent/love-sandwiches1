...
SHEET = GSPREAD_CLIENT.open('love_sandwiches1')
...
def validate_data(values):
    """
    Inside the values, convert all string values into integers.
...
def update_sales_worksheet(data):
    ...
    """
    print("Updating sales worksheets...\n")
...
def update_surplus_worksheet(data):
    ...
    surplus_worksheet.apend_row(data)
